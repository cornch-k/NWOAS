...
HV="$ROOT/m1n1_windows-s159/build/m1n1-s159-submit-deferred-256.bin"
PAYLOAD="$M1N1/m1n1-payload-s139-8cpu-usba.bin"
LOG=$(mktemp "$ROOT/nwoas_scripts/logs/usb-s159-$(date '+%Y%m%d-%H%M%S').XXXXXX")
...
[ "$(shasum -a 256 "$HV" | awk '{print $1}')" = 1acd193daa19864b577a7d9d548de577b76ce309f1e784eda6e08af9efaac510 ]
...
echo '[S159] Deferred SQ execution on HV tick; 8 cores, USB-A baseline' | tee -a "$LOG"

...
OUT=ROOT/'nwoas_scripts/rtc-s185'
...
inner=inner.replace('OUT = ROOT / "nwoas_scripts/smp-s131"','OUT = ROOT / "nwoas_scripts/rtc-s185/s131-build"')
inner=inner.replace('target = ROOT / "m1n1_windows/m1n1-payload-s131-8cpu.bin"',
                    'target = ROOT / "nwoas_scripts/rtc-s185/m1n1-payload-s185-hwrtc.bin"')
...
try:
    ...
    payload=OUT/'m1n1-payload-s185-hwrtc.bin'

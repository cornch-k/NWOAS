...
R=Path('/Volumes/X31/NWOAS');repo=R/'apple_silicon_platforms_mu';out=R/'nwoas_scripts/rtc-s185'
...
try:
 ...
 m=json.loads((out/'manifest.json').read_text());m['change']='S180 10GiBhigh+low4GiB,8cores,USB-A; direct SERA hardwareRTC boot read with physicalcounter runtime advance; no host date seed, SetTime unsupported'

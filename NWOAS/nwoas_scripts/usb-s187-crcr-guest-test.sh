...
LOG=$(mktemp "$ROOT/nwoas_scripts/logs/usb-s187-crcr-$(date '+%Y%m%d-%H%M%S').XXXXXX")
...
echo '[S187 crcr] USB-C XHC1 enabled, native hardware boot RTC, S180 RAM/8core; S16350us lateP12' | tee -a "$LOG"

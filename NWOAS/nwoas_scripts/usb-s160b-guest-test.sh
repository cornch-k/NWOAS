...
HV="$ROOT/m1n1_windows-s159/build/m1n1-s160b-local-mask.bin"
PAYLOAD="$M1N1/m1n1-payload-s139-8cpu-usba.bin"
LOG=$(mktemp "$ROOT/nwoas_scripts/logs/usb-s160b-$(date '+%Y%m%d-%H%M%S').XXXXXX")
...
[ "$(shasum -a 256 "$HV" | awk '{print $1}')" = b9cdfb5b2696f0e56e3f686a1dc52a0f77dd46e6fb9da989bcc03ecfd7e7b7cd ]

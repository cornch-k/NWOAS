...
R=Path('/Volumes/X31/NWOAS');repo=R/'apple_silicon_platforms_mu';out=R/'nwoas_scripts/usb-s187'
...
try:
 ...
 m=json.loads((out/'manifest.json').read_text());m['change']='S187 S180 10GiBhigh+low4GiB,8cores,USB-C XHC1 visible; direct SERA hardwareRTC boot read with physicalcounter runtime advance; no host date seed, SetTime unsupported'

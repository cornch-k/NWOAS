...
HV="$M1N1/build/m1n1-s98-nvme-gpt.bin"
PAYLOAD="$M1N1/m1n1-payload-s99-uefinvme.bin"
HOOK="$M1N1/tahoe_dcp_guest_hook.py"
MODULE="$M1N1/pcie_emul-d81-usbc-payload.py"
LOG=$(mktemp "$ROOT/nwoas_scripts/logs/nvme-s99-$(date '+%Y%m%d-%H%M%S').XXXXXX")
...
[ "$(shasum -a 256 "$HV" | awk '{print $1}')" = "0e5f4ce2c3c9b777e8db7cd89e71589080078b7b7c24c483a3fb80cd102bde5b" ]

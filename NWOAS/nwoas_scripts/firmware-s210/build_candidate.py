#!/usr/bin/env python3
"""S210: isolated UEFI Image-header correction candidate.
...
to nwoas_scripts/firmware-s210 so no S192 artifact or manifest is touched, and
...
out = R / 'nwoas_scripts/firmware-s210'
...
try:
    ...
    m['change'] = ('S210 = S192 (conformant RTC unseeded error + ReadyToBoot P12, S180 '

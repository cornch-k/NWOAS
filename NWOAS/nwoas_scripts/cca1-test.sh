...
PAYLOAD=m1n1-payload-cca1-v1.bin
MODULE=pcie_emul-exp5-fldiag3.py
VDM="$ROOT/macvdmtool/macvdmtool"
LOG="$ROOT/nwoas_scripts/logs/cca1-fldiag3.log"
: > "$LOG"
echo "=== deferred cca1(_CCA=One)+fldiag3 start $(date '+%H:%M:%S') payload=$PAYLOAD module=$MODULE ===" | tee -a "$LOG"

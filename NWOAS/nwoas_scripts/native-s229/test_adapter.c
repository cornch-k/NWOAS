...
int main(void)
{
 ...
 puts("PASS actual S229 adapter + S149 control/MMIO: page/carveout checks, admin publication, CQ ack without SQ, generation wrap, masks, shutdown and fatal backend");
}

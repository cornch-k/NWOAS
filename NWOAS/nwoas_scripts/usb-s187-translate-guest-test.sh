...
LOG=$(mktemp "$ROOT/nwoas_scripts/logs/usb-s187-translate-$(date '+%Y%m%d-%H%M%S').XXXXXX")
...
echo '[S187 translate] USB-C XHC1 enabled, native hardware boot RTC, S180 RAM/8core; S16350us lateP12' | tee -a "$LOG"

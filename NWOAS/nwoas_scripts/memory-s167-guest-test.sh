...
LOG=$(mktemp "$ROOT/nwoas_scripts/logs/memory-s167-$(date '+%Y%m%d-%H%M%S').XXXXXX")
...
echo '[S167] S161 normalization plus 4 GiB high RAM; S163 gap50us, P7, 8 cores USB-A' | tee -a "$LOG"

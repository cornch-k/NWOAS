...
HV="$ROOT/nwoas_scripts/usb-s182/m1n1-s182-crcr-gap50.bin"
PAYLOAD="$ROOT/nwoas_scripts/usb-s174/m1n1-payload-s174-8cpu-usbc.bin"
LOG=$(mktemp "$ROOT/nwoas_scripts/logs/usb-s182-crcr-$(date '+%Y%m%d-%H%M%S').XXXXXX")
...
[ "$(shasum -a 256 "$HV" | awk '{print $1}')" = 96da22db21c78f309d7faff2eb62ff50e12976e0eb4b67a635cc9697a4a43e78 ]

...
w=Path('/Volumes/X31/NWOAS/m1n1-admin-s230');t=(w/'src/hv_vm.c').read_text()
...
PY
/usr/bin/clang -std=c11 -O1 -g -Wall -Wextra -Werror -Wno-unused-function -fsanitize=address,undefined -fno-sanitize-recover=all -Iout -I. -I/Volumes/X31/NWOAS/m1n1-admin-s230/src -I../native-s209 -I../native-s225 -I../native-s226 -I../native-s227 -I../native-s228 test_adapter.c ../native-s228/frontend.c ../native-s209/model.c ../native-s227/admin_ring.c ../native-s226/admin_state.c ../native-s225/admin_payload.c -o out/test-adapter
./out/test-adapter

...
def _query_validate(value):
    ...
    if any(type(a) is not int or a not in (3,4,5,6,7,8,9,10,17,18,19,20,21,22,23) for a in actions):
        raise ValueError('only read-only actions 3..10 and 17..23 are allowed')

...
s=(root/'nwos.c').read_text().replace('typedef unsigned long U32;','typedef unsigned int U32;').replace('#define IMP __declspec(dllimport)','#define IMP')
stub=r'''
#include <stdlib.h>
#include <string.h>
#include <stdio.h>
...
U32 GetEnvironmentVariableW(const W *name,W *b,U32 n){(void)name;(void)n;b[0]='C';b[1]=':';b[2]=0;return 2;}
int main(void){

...
static int run(U32 job,U32 n){
 static W script[]=L"C:\\Windows\\Temp\\NWOAS123.CMD",app[]=L"C:\\Windows\\System32\\cmd.exe";
 static W command[]=L"cmd.exe /d /c C:\\Windows\\Temp\\NWOAS123.CMD";
 ...
 if(!CreateProcessW(app,command,0,0,1,0,0,L"C:\\",&si,&pi)){
...
void mainCRTStartup(void){
 ...
 emit("NWOAS S123 host link; installed Windows worker\r\n");

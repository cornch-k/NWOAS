#!/bin/bash
# S223: S216 code plus explicit 480KiB erased-value FD tail padding.
...
LOG=$(mktemp "$ROOT/nwoas_scripts/logs/loader-s223-fd-tail-$(date '+%Y%m%d-%H%M%S').XXXXXX")
...
echo '[S223] S216 code, deterministic FD tail; S208 gap50' | tee -a "$LOG"

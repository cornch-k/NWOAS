#!/bin/bash
# S131: eight-core MADT + indexed PSCI AP state, with S129 SSD-first boot.
...
[ "$(shasum -a 256 "$HV" | awk '{print $1}')" = "0c612607debfbf5524a0f2c1431e551b8604ea24d1ad2c59e2c68dfd7d518967" ]
...
echo "[S131] eight-core MADT + indexed PSCI state; S129 SSD-first; S130 quiet NVMe" | tee -a "$LOG"

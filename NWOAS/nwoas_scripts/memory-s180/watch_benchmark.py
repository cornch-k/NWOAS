...
while time.monotonic()<deadline:
 ...
 proc=subprocess.run([sys.executable,str(root/'transport-s123/queue_job.py'),str(link),str(root/'memory-s180/inspect-benchmark.cmd')],capture_output=True,text=True)

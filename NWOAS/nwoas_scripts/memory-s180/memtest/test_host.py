...
with tempfile.TemporaryDirectory() as d:
 ...
 for _ in range(2000):
  i=rng.randrange(0,10240*1048576//8);v=rng.randrange(10);assert lib.pattern(i,v)==py(i,v)
 for s,result in [('MEMTEST.EXE',(4096,3)),('"D:\\MEMTEST.EXE" 4096 3',(4096,3)),('x 64 1',(64,1)),('x 10240 10',(10240,10)),('x 63',None),('x 10241',None),('x 64 0',None),('x 64 11',None),('x 64 1 2',None),('x -1',None),('x 999999999999999999',None),('x 64bad',None),('"x',None)]:
